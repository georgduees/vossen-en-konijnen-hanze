...
public class Field
{
    ...
    /**
     * Get a shuffled list of the free adjacent locations weather there is grass or not doesnt matter.
    ...
    /**
     * Return a shuffled list of locations adjacent to the given one in a radious of 2.
     * The list will not include the location itself.
     * All locations will lie within the grid.
     * @param location The location from which to generate adjacencies.
     * @return A list of locations adjacent to that given.
    ...
    /**
     * a method to see whether there is Grass at the location or not.
     */
